...
#Installation
	...
	sudo apt install postgresql-client nodejs wget npm -y
...
#Fichier de conf pour shopsphere
    ...
    cd /opt/
    sudo wget https://github.com/TristanJodry/Shopsphere/raw/main/shopsphere.tar.gz
...
PGPASSWORD='ShopSphere2024!' psql -h 192.168.0.3 -U shopsphere_user -d shopsphere -c "SELECT 1"